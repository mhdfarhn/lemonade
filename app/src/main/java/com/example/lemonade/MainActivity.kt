    ...
    Scaffold(
        ...
        Surface(
            ...
            when (currentStep) {
                ...
                2 -> {
                    LemonImageAndText(
                        textResourceId = R.string.lemon_squeeze_text,
                        imageResourceId = R.drawable.lemon_squeeze,
                        contentDescriptionResourceId = R.string.lemon_squeeze_description,
                        onImageClick = {
                            squeezeCount--
                            if (squeezeCount == 0) {
                                currentStep = 3
                ...
                3 -> {
                    LemonImageAndText(
                        textResourceId = R.string.lemon_drink_text,
                ...
                4 -> {
                    LemonImageAndText(
                        textResourceId = R.string.lemon_restart_text,
